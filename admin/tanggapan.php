        ...
        <div class="card-body">
            <form action="simpan_tanggapan.php" method="post" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="form-group col-sm-6">
                    ...
                    <input type="text" name="id_pengaduan" value="<?= $_GET['id'] ?>" class="form-control" readonly="">
                </div>
                ...
                <div class="form-group col-sm-6">
                    ...
                    <input type="text" name="id_petugas" value="<?= $_SESSION['id_petugas'] ?>" class="form-control" readonly>
                </div>
