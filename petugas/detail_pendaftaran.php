        ...
        ?>
            <div class="card-body">
                <div class="col-sm-6">
                    ...
                    <a href="proses_daftar.php?id=<?= $data['id_pendaftaran'] ?>" class="btn btn-primary btn-sm"><i class="fas fa-check" onclick='alert("Data Akan Diproses?")'></i>Proses Verifikasi</a>
                </div>
            </div>
            ...
            <div class="card-body">
                <form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input type="text" name="jumlah_penghuni" value="<?= $data['jumlah_penghuni'] ?>" class="form-control" readonly>
                    </div>
                    <div class="form-group col-sm-6">
                        <label>Jeni Bangunan</label>
