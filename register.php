                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <img src="img/gam1.png" width="70" alt="">
                                        <h2>Registrasi Akun</h2>
                                    </div>
                                    <form class="user" method="POST" action="simpan_masyarakat.php">
                                        <div class="form-group">
                                            <input type="text" name="nik" class="form-control form-control-user" id="nik" placeholder="NIK...">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="telp" class="form-control form-control-user" id="telp" placeholder="Telephone...">
                                        </div>
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="large font-weight-bold" href="index.php">Login jika sudah punya akun!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
