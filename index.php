                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <img src="img/gam1.png" width="200" alt="">
                                    </div>
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small btn btn-success btn-sm" href="register.php">Buat akun baru?</a>
                                    </div><br>
                                    <div class="text-center">
                                        <a class="large font-weight-bold text-danger font-italic" href="index2.php">Masuk sebagai admin/petugas</a>
                                    </div>
                                </div>
                            </div>
                        </div>
